...
const RCL = {
  ...
  B: {
    ...
    epiphany: [
      { week: 1, label: '第一週（主日）', ot: '創 1:1-5',           ps: '詩 29',                 ep: '徒 19:1-7',        gos: '可 1:4-11'   },
      { week: 2, label: '第二週（主日）', ot: '撒上 3:1-10',        ps: '詩 139:1-6, 13-18',     ep: '林前 6:12-20',     gos: '約 1:43-51'  },
      { week: 3, label: '第三週（主日）', ot: '拿 3:1-5, 10',       ps: '詩 62:5-12',            ep: '林前 7:29-31',     gos: '可 1:14-20'  },
      { week: 4, label: '第四週（主日）', ot: '申 18:15-20',        ps: '詩 111',                ep: '林前 8:1-13',      gos: '可 1:21-28'  },
