...
<template>
  <div class="mission-page">
    <h1 class="page-main-title">
      <span class="emoji">📜</span>使命宣言<span class="emoji">📜</span>
    </h1>
    ...
    <br />
    <p class="signature">執筆者　張辰瑋 <span class="date">2025.02.09</span></p>
  </div>
</template>
